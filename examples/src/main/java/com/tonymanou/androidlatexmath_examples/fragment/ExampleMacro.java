...
/**
 * This shows how to write new macros in Java or how to add new predefined formulas.
 * <p>The following files come along to this example:
 * <ul>
...
public class ExampleMacro extends BaseExample {
    ...
    @Override
    protected void doExample() throws Exception {
        InputStream inputStream = getContext().getAssets().open("Package_Foo.xml");
        TeXFormula.addPredefinedCommands(inputStream);
